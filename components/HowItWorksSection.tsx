...
const customSolutionProcess = {
  ...
  description:
    "Our expert engineers design and implement tailored electrical solutions that meet your specific requirements while ensuring maximum efficiency and safety.",
...
const workPrinciples = [
  ...
  },
  {
    ...
    title: "Safety First",
    description:
      "We prioritize safety in every project with rigorous protocols",
  },
  {
...
export default function HowWeWorkSection() {
  ...
  return (
    <section
      id="projects"
      className="w-full py-20 md:py-20 relative overflow-hidden"
    >
      ...
      <div className="container px-4 md:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-12 max-w-3xl mx-auto">
            We prioritize safety, precision, and sustainable practices in every
            project. Our systematic approach ensures cutting-edge solutions
            tailored to meet your distinctive electrical engineering demands.
          </p>
        </motion.div>
                  ...
                  <div className="space-y-4">
                    {customSolutionProcess.details.map((detail, index) => (
                      <div key={index} className="flex items-start gap-4 group">
                        ...
                        <span className="text-lg group-hover:text-foreground transition-colors duration-200">
                          {detail}
                        </span>
                      </div>
                    ))}
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Every project is guided by these fundamental principles that
              ensure exceptional results and client satisfaction.
            </p>
          </div>
